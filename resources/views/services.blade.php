                ...
                <div class="service-content">
                    ...
                    <div class="loan-purpose-section">
                        ...
                        <div class="purpose-grid">
                            ...
                            <div class="purpose-card">
                                <span class="purpose-checkmark">✔</span>
                                <span class="purpose-text">Street vendors</span>
                            </div>
                            <div class="purpose-card">
                                <span class="purpose-checkmark">✔</span>
                                <span class="purpose-text">Small retail sellers</span>
                            </div>
                            <div class="purpose-card">
                                <span class="purpose-checkmark">✔</span>
                                <span class="purpose-text">Service providers</span>
                            </div>
                            <div class="purpose-card">
                                <span class="purpose-checkmark">✔</span>
                                <span class="purpose-text">Local traders</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="features-section">
                        ...
                        <div class="features-grid">
                            <div class="feature-card">
                                ...
                                <p class="feature-description">Convenient daily collection system that aligns with your daily income, making repayments manageable and stress-free.</p>
                            </div>
                            <div class="feature-card">
                                <span class="feature-icon">⚡</span>
                                <h5 class="feature-name">Quick Loan Processing</h5>
                                <p class="feature-description">Fast and efficient loan approval process to get you the funds you need when you need them most.</p>
                            </div>
                            <div class="feature-card">
                                <span class="feature-icon">📅</span>
                                <h5 class="feature-name">Short-term Financial Support</h5>
                                <p class="feature-description">Designed for short-term needs with flexible terms that match your business cycle and cash flow patterns.</p>
                            </div>
                            <div class="feature-card">
                                <span class="feature-icon">💼</span>
