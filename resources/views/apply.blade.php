...
<head>
    ...
    <meta name="description" content="Apply for Loan - People in Microfinance - Submit your loan application">
    
    <title>Apply for Loan - People in Microfinance</title>
        ...
        <div class="container">
            <div class="section-content scroll-reveal">
                <form class="loan-form" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="member_id" class="form-label">Member ID / Group Name<span class="required">*</span></label>
                        <input 
                            type="text" 
                            id="member_id" 
                            name="member_id" 
                            class="form-input" 
                            placeholder="Enter Member ID or Group Name"
                            required
                        >
                    </div>
                    ...
                    <div class="form-group">
                        <label for="occupation" class="form-label">Occupation / Business Type<span class="required">*</span></label>
                        <input 
                            type="text" 
                            id="occupation" 
                            name="occupation" 
                    ...
                    <div class="form-group">
                        <label for="monthly_income" class="form-label">Monthly Income<span class="required">*</span></label>
                        <input 
                            type="number" 
                            id="monthly_income" 
                            name="monthly_income" 
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            <option value="small_trader">Small Trader Loans</option>
                            <option value="daily_collection">Daily Collection Loans</option>
                            <option value="group_personal">Group Personal Loans</option>
                            <option value="consumer_durable">Consumer Durable Loans</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="loan_purpose" class="form-label">Loan Purpose<span class="required">*</span></label>
                        <textarea 
                            id="loan_purpose" 
                            name="loan_purpose" 
                            class="form-textarea" 
                    ...
                    <div class="form-group">
                        <label for="documents" class="form-label">Upload Documents<span class="required">*</span></label>
                        <div class="form-file">
                            <input 
                                type="file" 
                                id="documents" 
                                ...
                                required
                            >
                            <p style="margin-top: 0.5rem; font-size: 0.875rem; color: var(--text-gray);">
                                Accepted formats: PDF, JPG, PNG, DOC, DOCX (Multiple files allowed)
                            </p>
                        </div>
                    </div>
